...
#
# html_title = 'HDX Python API v0.3'
...
man_pages = [(master_doc, "hdxprojectapi", "HDX Python API Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "HDXPythonAPI",
        "The HDX Python Library enables your code to interact with the Humanitarian Data Exchange.",
        "Miscellaneous",
    ),
]
