...
class TestText:
    ...
    def test_get_matching_text(self):
        ...
        result = get_matching_text(TestText.a, TestText.b, match_min_size=9, end_characters='.!\r\n')
        ...
        result = get_matching_text(TestText.a, TestText.c, match_min_size=5, end_characters='.\r\n')
