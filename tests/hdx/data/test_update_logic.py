...
class TestUpdateLogic:
    ...
    def test_update_logic(
        self, configuration, new_resources_yaml, resources_yaml
    ):
        dataset_data = {
        ...
        resources_uploads = load_yaml(new_resources_yaml)
        for resource_upload in resources_uploads:
        ...
        resources = load_yaml(resources_yaml)
