...
class TestDatasetTitleHelper:
    ...
    def expected_ranges_2019(self):
        return [
            (
                ...
                datetime(2019, 7, 31, 23, 59, 59, 999999, tzinfo=timezone.utc),
            )
        ]
    ...
    def test_get_date_from_title(self, expected_ranges_2019):
        ...
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2019, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2019, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(1981, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2015, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2017, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2017, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2001, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2013, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2018, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2018, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2019, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2019, 1, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2019, 5, 5, 0, 0, tzinfo=timezone.utc), datetime(2019, 5, 5, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            "Tanintharyi Region Land Cover - March 2016 (Original)"
        ) == (
            "Tanintharyi Region Land Cover (Original)",
            [(datetime(2016, 3, 1, 0, 0, tzinfo=timezone.utc), datetime(2016, 3, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            "Kachin State and Sagaing Region 2002-2014 Forest Cover Change"
        ) == (
            "Kachin State and Sagaing Region Forest Cover Change",
            [(datetime(2002, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2014, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
        ...
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2013, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2013, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2019, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2019, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2013, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2014, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title("ALCS 2000/10") == (
            "ALCS",
            [(datetime(2000, 10, 1, 0, 0, tzinfo=timezone.utc), datetime(2000, 10, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            "ALCS 2014/13"
        ...
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2001, 12, 10, 0, 0, tzinfo=timezone.utc), datetime(2001, 12, 10, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2016, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2016, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2019, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2019, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [(datetime(2019, 2, 5, 0, 0, tzinfo=timezone.utc), datetime(2019, 2, 5, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2001, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2012, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2016, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2017, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2007, 8, 1, 0, 0, tzinfo=timezone.utc), datetime(2014, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2016, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2016, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            "Risk, 2020/19",
            [(datetime(2014, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2014, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            "south sudan access constraints shp for 20200124"
        ) == (
            "south sudan access constraints shp",
            [(datetime(2020, 1, 24, 0, 0, tzinfo=timezone.utc), datetime(2020, 1, 24, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            "Cambodia Flood Extent in 2011"
        ) == (
            "Cambodia Flood Extent",
            [(datetime(2011, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2011, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc))],
        )
        assert DatasetTitleHelper.get_dates_from_title(
            ...
            [
                (datetime(2011, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2013, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
                (datetime(2013, 1, 1, 0, 0, tzinfo=timezone.utc), datetime(2013, 12, 31, 23, 59, 59, 999999, tzinfo=timezone.utc)),
            ],
        )
