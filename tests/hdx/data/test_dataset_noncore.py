...
class TestDatasetNoncore:
    ...
    def test_generate_resource_view(self, configuration, vocabulary_update, static_resource_view_yaml):
        ...
        indicators = [{'code': '1', 'title': 'My1', 'unit': 'ones', 'description': 'This is my one!'},
                      ...
                      {'code': '3', 'title': 'My3', 'description': 'This is my three!', 'date_col': 'dt3'}]
        ...
        resourceview = dataset.generate_resource_view(indicators=indicators, findreplace={'#indicator+code': '#item+code', '#indicator+value+num': '#value'})
        hxl_preview_config = json.loads(resourceview['hxl_preview_config'])
        assert resourceview['id'] == 'c06b5a0d-1d41-4a74-a196-41c251c76023'
        ...
        with temp_dir('test') as folder:
            ...
            with Download(user_agent='test') as downloader:
                ...
                assert results == {'startdate': datetime.datetime(2001, 1, 1, 0, 0), 'enddate': datetime.datetime(2002, 12, 31, 0, 0), 'bites_disabled': [False, True, False],
                                   'resource': {'description': 'Conflict data with HXL tags', 'format': 'csv', 'name': 'Conflict Data for Algeria', 'resource_type': 'file.upload', 'url_type': 'upload'},
                                   ...
                                   'qc_resource': {'description': 'Cut down data for QuickCharts', 'format': 'csv', 'name': 'QuickCharts-Conflict Data for Algeria', 'resource_type': 'file.upload', 'url_type': 'upload'},
                ...
                assert results == {'startdate': datetime.datetime(2001, 1, 1, 0, 0), 'enddate': datetime.datetime(2002, 12, 31, 0, 0), 'bites_disabled': [False, True, False],
                                   ...
                                   'qcrows': [{'EVENT_ID_CNTY': '#event+code', 'FATALITIES': '#affected+killed'}, {'EVENT_ID_CNTY': '1416RTA', 'FATALITIES': '1'}, {'EVENT_ID_CNTY': '2231RTA', 'FATALITIES': '0'}]}
